...
> [!WARNING]
> CoffeeNotes is currently under active development. Features may be incomplete,
...
## Language
This app is written in react native with a backend on supabase
...
2. Fill inn the following:
   - Title
   - Note 
   - Add a photo (not mandatory)
